...
UI is built on `lockwright-lib-ui-react-native-components`. All new UI and edits to existing screens **must** use components from this kit. Do not roll custom buttons, inputs, modals, typography, or icons.
